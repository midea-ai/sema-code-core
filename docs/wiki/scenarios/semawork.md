...
- **对话与工具可视化** — 流式回复、工具调用卡片、权限应答、待办列表
- **代码审阅** — 查看会话中的文件改动 diff
- **右侧面板** — 终端、内嵌浏览器、文件预览多标签并存
- **任务面板** — 定时任务管理、快问旁路问答、子代理运行详情
- **项目 / 会话管理** — 项目与独立会话两级组织，支持分支到新聊天、刷新与断线恢复

## 启动方式

见[快速开始 · 方式一](wiki/getting-started/quick-start)。
