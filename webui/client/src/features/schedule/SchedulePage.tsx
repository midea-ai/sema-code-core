  ...
  return (
    <div className="flex-1 min-h-0 flex flex-col">
      ...
      <div className="flex-1 min-h-0 flex">
        ...
        <div ref={rightRef} className="flex-1 min-h-0 overflow-y-auto">
            ...
            {groups === null ? (
              ...
              <section key={g.workingDir}>
                <div className="flex items-center gap-2 mb-2 min-w-0">
                  ...
                  <span className="font-medium truncate shrink-0 max-w-[45%]">{g.projectName}</span>
                  <span className="text-xs text-muted truncate" title={g.workingDir}>{shortPath(g.workingDir)}</span>
